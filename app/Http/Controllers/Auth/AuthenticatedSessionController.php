...
class AuthenticatedSessionController extends Controller
{
    ...
    public function ssoCallback()
    {
        ...
        if(Session::exists(self::SSO_BRIDGE_REDIRECT_URI_SESSION_KEY))
        {
            ...
            if(\Cache::pull(SSOBridgeController::SSO_BRIDGE_CORRELATION_ID_GENERATOR . $correlationId,null)==null)
            {
                Log::warning("Received sso with correlationId not generated by us/ missing from the cache",["correlationId"=>$correlationId]);
                $response->header("Warning",[110,"sso-bridge","CorrelationId should be generated from us, please use ".route('ssobridge.create-correlation-id')]);
                //Wait for clients to upgrade...TODO
                //abort(500,"Invalid correlationId");
            }

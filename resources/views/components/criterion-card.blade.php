<div
    ...
    dark:border-gray-700 rounded-lg p-3 hover:shadow-lg transition-shadow duration-300">

    <!-- Nom du critère -->
    <div data-criterion-name="Name"
        class="criterion-name text-xl font-bold flex-1
     text-gray-800 dark:text-white mb-4
     text-center overflow-hidden whitespace-nowrap overflow-ellipsis max-w-lg">
        {{ $criterion['name'] }}
    </div>
